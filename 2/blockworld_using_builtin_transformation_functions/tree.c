...
void bwMainBranch()
{
   ...
   glPopMatrix();
   glPushMatrix();
   glTranslated(0, 0, SIZEBRANCH);
   bwBranch();
   glPopMatrix();
   glPushMatrix();
   glTranslated(0, SIZEBRANCH, 0);
   bwBranch();
   glPopMatrix();
   glPushMatrix();
   glTranslated(0, SIZEBRANCH, SIZEBRANCH);
   bwBranch();
   glPopMatrix();
   
   glPushMatrix();
   glTranslated(SIZEBRANCH, SIZEBRANCH / 2, 0);
   bwBranch();
   glPopMatrix();
   glPushMatrix();
   glTranslated(SIZEBRANCH, SIZEBRANCH / 2, SIZEBRANCH);
   bwBranch();
   glPopMatrix();
   glPushMatrix();
   glTranslated(SIZEBRANCH, -1 * SIZEBRANCH / 2, SIZEBRANCH / 3);
   bwBranch();
   glPopMatrix();
   
   glPushMatrix();
   glTranslated(2.1 * SIZEBRANCH, SIZEBRANCH / 2, SIZEBRANCH / 2);
   bwBranch();
   glPopMatrix();
}
...
void bwTree()
{
   ...
   for(i = 0; i < MAINBRANCHLEVELS; i++)
      ...
      {
         glPushMatrix();
         glTranslated(2 * SIZESTUB, SIZETRUNK + (1 + i) * SIZEMAINBRANCHh, 2 * SIZESTUB);
         glRotated((j * SEPARATIONBWMAINBRANCHES) % 360, 0, 1, 0);
         bwMainBranch();
         glPopMatrix();
         
         glPushMatrix();
         glTranslated(SIZESTUB + SIZEMAINBRANCHl, SIZETRUNK + (1 + i) * SIZEMAINBRANCHh, 0);
         glRotated((j * SEPARATIONBWMAINBRANCHES + SEPARATIONBWMAINBRANCHES / 2) % 360, 0, 1, 0);
         bwMainBranch();
         glPopMatrix();
   ...
   {
      glPushMatrix();
      glTranslated(0, SIZETRUNK + (1 + i) * SIZEMAINBRANCHh - SIZEBRANCH / 2, 0);
      glRotated(j * SEPARATIONBWMAINBRANCHES, 0, 1, 0);
      bwMainBranch();
      glPopMatrix();
   }
   
   glPushMatrix();
   glTranslated(0, SIZETRUNK + (2 + i) * SIZEMAINBRANCHh - SIZEBRANCH / 2, 0);
   bwBranch();
   glPopMatrix();
}
